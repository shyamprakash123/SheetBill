    ...
    <DrawerPortal>
      <DrawerOverlay>
        <DrawerPrimitives.Content
          ...
          className={cx(
            // base
            "fixed inset-y-2 z-50 mx-auto flex w-[95vw] !h-[calc(100vh-1rem)] flex-1 flex-col overflow-y-auto rounded-md border shadow-lg focus:outline-hidden max-sm:inset-x-2 sm:inset-y-2 sm:right-2 sm:max-w-lg",
            // border color
...
>(({ children, className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className="flex items-center justify-between gap-x-4 border-b border-gray-200 pb-1 dark:border-gray-900 px-2"
      {...props}
    >
