...
export default function InvoiceFormModal({ isOpen, onClose, invoice }: InvoiceFormModalProps) {
  const { 
    customers, 
    products, 
    createInvoice, 
  ...
  const handleAddItem = (product: any) => {
    const newItem: InvoiceItem = {
      ...
      taxRate: parseFloat(product.taxRate?.replace('%', '')) || 18,
      taxAmount: (product.price * (parseFloat(product.taxRate?.replace('%', '')) || 18)) / 100
    }
              ...
              >
                ...
                <div className="flex items-center justify-end space-x-3 p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
                  ...
                  <Button
                    onClick={handleSave}
                    loading={loading}
                    disabled={!formData.customerName.trim() || formData.items.length === 0}
                  >
        ...
        <div className="space-y-4">
          {customers.length === 0 ? (
            <div className="text-center py-8">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                <h4 className="font-medium text-gray-900 dark:text-white mb-3">Add New Customer</h4>
                <div className="space-y-3">
                  <input
                    type="text"
          ...
          {products.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                No products found. Please add products in the Inventory section first.
              </p>
            </div>
          ) : (
